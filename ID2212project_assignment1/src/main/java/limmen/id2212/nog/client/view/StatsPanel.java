...
import limmen.id2212.nog.client.model.Participant;
...
class StatsPanel extends JPanel {
    ...
    private int totalCountries(ArrayList<Participant> participants){
    ...
    private int totalSports(ArrayList<Participant> participants){
    ...
    private float averageWeight(ArrayList<Participant> participants){
        float totalWeight = 0;
        for(Participant p : participants){
    ...
    private float averageHeight(ArrayList<Participant> participants){
        float totalHeight = 0;
        for(Participant p : participants){
