...
public class Server {
    ...
    private ArrayList<ParticipantImpl> readFile(){
        ArrayList<ParticipantImpl> participants = new ArrayList();
        ...
        try{
            ...
            while (str != null) {
                ...
                participants.add(new ParticipantImpl(Integer.parseInt(values[0]),
